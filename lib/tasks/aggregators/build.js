...
const {isTypescriptProject, handleRunSequenceErrors, isBabelProject, nodeVersionLock} = require('../../utils');
...
function forceNodeVersionTask() {
  if (!nodeVersionLock())
    return 'update-node-version';
  else
    return 'no-update-node-version';
}